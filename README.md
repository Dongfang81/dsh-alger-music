...
> 我对它说：**「大话西游里面很有名的那首歌叫什么来着，不是 only you，是另一首有名的」**
>
> 它回答我：**《一生所爱》——卢冠廷演唱，莫文蔚和声，大话西游最催泪的那首片尾曲。**
>
> （其实它连《Only You》也一起找到了，只是知道你要的是另一首。）

哪怕你连歌名都记不清，只有一个模糊的印象——「大话西游里那首有名的」「某年春晚的合唱」——它都能从记忆碎片里帮你把歌捞出来。**传统播放器的搜索框，做得到吗？**

## 🎬 宣传视频

[`demo/promo.mp4`](./demo/promo.mp4)：60 秒宣传片
（对话点歌 → 推荐开播 → Moony 随乐起舞 → 智能推荐展望）。

## ✨ 为什么它是「AI 原生」

| 传统播放器 | 月宝 Moony |
| --- | --- |
| 你要自己搜、自己加、自己建歌单 | 说一句「我想听任素汐的全部歌」，它全网搜集、去重整理、剔除伴奏、整单开播 |
...
**关于音源**：网易云 API 只负责元数据（搜索/歌词/封面/歌单）；
版权受限或下架的歌曲，会自动从其他开源音源按「歌名 - 歌手」匹配原版完整音源——
所以「双截棍」即使网易云下架，也能听到周杰伦原版。
