...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var MOONY_CSS = [
			...
			".dsa-moony-pet[data-moony-ear='classic'] .dsa-moony-ear{top:-16px;width:22px;height:22px;border-radius:55% 45% 25% 30%}.dsa-moony-pet[data-moony-ear='classic'] .left{left:3px}.dsa-moony-pet[data-moony-ear='classic'] .right{right:3px}",
			".dsa-moony-pet[data-moony-ear='pulse'] .dsa-moony-ear{top:-32px;width:27px;height:48px;border-radius:59% 41% 20% 30%;clip-path:polygon(0 0,100% 8%,72% 100%,48% 66%,25% 100%)}.dsa-moony-pet[data-moony-ear='pulse'] .left{left:1px;transform:rotate(-12deg)}.dsa-moony-pet[data-moony-ear='pulse'] .right{right:1px;transform:scaleX(-1) rotate(-12deg)}",
			".dsa-moony-pet[data-moony-ear='echo'] .dsa-moony-ear{top:-22px;width:39px;height:34px;border-radius:65% 35% 58% 42%;clip-path:polygon(0 14%,100% 0,72% 100%,18% 82%)}.dsa-moony-pet[data-moony-ear='echo'] .left{left:-9px;transform:rotate(-18deg)}.dsa-moony-pet[data-moony-ear='echo'] .right{right:-9px;transform:scaleX(-1) rotate(-18deg)}",
			".dsa-moony-pet[data-moony-ear='drift'] .dsa-moony-ear{top:-39px;width:24px;height:59px;border-radius:55% 45% 68% 32%}.dsa-moony-pet[data-moony-ear='drift'] .left{left:-18px;transform:rotate(26deg)}.dsa-moony-pet[data-moony-ear='drift'] .right{right:-18px;transform:rotate(-26deg)}",
			".dsa-moony-pet[data-moony-ear='spark'] .left{left:5px;top:-35px;width:19px;height:50px;border-radius:60% 40% 18% 28%;transform:rotate(-23deg)}.dsa-moony-pet[data-moony-ear='spark'] .right{right:-7px;top:-16px;width:37px;height:29px;border-radius:70% 30% 55% 45%;transform:rotate(8deg)}",
			".dsa-moony-pet[data-moony-ear='chorus'] .dsa-moony-ear{top:-27px;width:39px;height:40px;clip-path:polygon(50% 0,65% 39%,100% 20%,76% 60%,98% 84%,56% 75%,40% 100%,29% 68%,0 75%,25% 47%)}.dsa-moony-pet[data-moony-ear='chorus'] .left{left:-7px;transform:rotate(-9deg)}.dsa-moony-pet[data-moony-ear='chorus'] .right{right:-7px;transform:scaleX(-1) rotate(-9deg)}",
			...
			".dsa-moony-pet[data-moony-ear='loop'] .dsa-moony-ear{top:-27px;width:33px;height:38px;border:5px solid var(--moony-rim);border-radius:50%;background:transparent;box-shadow:inset 0 0 8px var(--moony-light-soft),0 0 9px var(--moony-rim-soft)}.dsa-moony-pet[data-moony-ear='loop'] .dsa-moony-ear::before{inset:5px;background:transparent}.dsa-moony-pet[data-moony-ear='loop'] .left{left:-4px;transform:rotate(-18deg)}.dsa-moony-pet[data-moony-ear='loop'] .right{right:-4px;transform:rotate(18deg)}",
			".dsa-moony-pet[data-moony-ear='bass'] .dsa-moony-ear{top:-14px;width:31px;height:24px;border-radius:58% 42% 34% 28%}.dsa-moony-pet[data-moony-ear='bass'] .left{left:-2px;transform:rotate(-10deg)}.dsa-moony-pet[data-moony-ear='bass'] .right{right:-2px;transform:rotate(10deg)}",
			".dsa-moony-pet[data-moony-ear='vinyl'] .dsa-moony-ear{top:-19px;width:29px;height:29px;border-radius:50%;box-shadow:inset 0 0 0 5px rgba(34,20,26,.18),inset 0 0 0 7px var(--moony-light-soft),0 0 9px var(--moony-rim-soft)}.dsa-moony-pet[data-moony-ear='vinyl'] .left{left:-3px}.dsa-moony-pet[data-moony-ear='vinyl'] .right{right:-3px}",
