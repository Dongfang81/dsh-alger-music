...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var MOONY_CSS = [
			...
			".dsa-moony-pet[data-moony-ear='classic'] .dsa-moony-ear{top:-20px;width:22px;height:22px;border-radius:55% 45% 25% 30%}.dsa-moony-pet[data-moony-ear='classic'] .left{left:3px}.dsa-moony-pet[data-moony-ear='classic'] .right{right:3px}",
			...
			".dsa-moony-pet[data-moony-ear='drift'] .dsa-moony-ear{top:-43px;width:24px;height:59px;border-radius:55% 45% 68% 32%}.dsa-moony-pet[data-moony-ear='drift'] .left{left:-18px;transform:rotate(26deg)}.dsa-moony-pet[data-moony-ear='drift'] .right{right:-18px;transform:rotate(-26deg)}",
